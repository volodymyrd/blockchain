...
pub use shard_chunk_header_inner::{ShardChunkHeaderInner, ShardChunkHeaderInnerV3};
...
impl ShardChunkHeaderV3 {
    ...
    pub fn new(
        ...
        let congestion_info = congestion_info.unwrap();
...
impl PartialEncodedChunk {
    pub fn new(
        ...
        match header {
            header => Self::V2(PartialEncodedChunkV2 {
                header,
                parts,
...
impl EncodedShardChunk {
    ...
    pub fn new(
        ...
        let content = EncodedShardChunkBody {
            parts: transaction_receipts_parts,
        };
